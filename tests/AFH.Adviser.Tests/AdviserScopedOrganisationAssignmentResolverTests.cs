...
public sealed class AdviserScopedOrganisationAssignmentResolverTests
{
        ...
        IReadOnlyList<OrganisationAssignment> assignments)
    {
        ...
        directory.Setup(x => x.SearchAsync(It.IsAny<OrganisationAssignmentSearch>(), It.IsAny<CancellationToken>()))
            .ReturnsAsync((OrganisationAssignmentSearch search, CancellationToken _) =>
            {
