...
namespace AFH.Adviser.Infrastructure.Migrations
{
    ...
    [Migration("20260628205448_SyncAdviserDirectoryModel")]
    partial class SyncAdviserDirectoryModel
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AFH.Adviser.Infrastructure.Persistence.Coverage.Entities.AdviserRegionAssignmentEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                    ...
                    b.HasIndex("RegionId", "AdviserId")
                        .IsUnique();

                    b.ToTable("AdviserRegionAssignments", (string)null);
                });

            modelBuilder.Entity("AFH.Adviser.Infrastructure.Persistence.Coverage.Entities.CoverageRegionEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<string>("LeadAdviserId")
                        .HasMaxLength(100)
                        .HasColumnType("nvarchar(100)");

                    b.Property<string>("LeadAdviserName")
                        .HasMaxLength(200)
                        .HasColumnType("nvarchar(200)");
                    ...
                    b.ToTable("CoverageRegions", (string)null);
                });
            ...
            modelBuilder.Entity("AFH.Adviser.Infrastructure.Persistence.Coverage.Entities.AdviserRegionAssignmentEntity", b =>
                {
                    b.HasOne("AFH.Adviser.Infrastructure.Persistence.Coverage.Entities.CoverageRegionEntity", "Region")
                        .WithMany("AdviserAssignments")
            ...
            modelBuilder.Entity("AFH.Adviser.Infrastructure.Persistence.Coverage.Entities.CoverageRegionEntity", b =>
                {
                    b.Navigation("AdviserAssignments");
                });
