...
('LeadTech', 'Dashboard.Read'),
('LeadTech', 'Bookings.Admin.Read'),
...
('LeadTech', 'Advisers.Read'),
('LeadTech', 'Advisers.Skills.Read'),
('LeadTech', 'Calendar.Read'),
('LeadTech', 'Coverage.Read'),
('LeadTech', 'CoverageRegions.Read'),
